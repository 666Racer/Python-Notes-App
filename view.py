...
class Start(object):    
    ...
    new_body_text = ("\n     Введите новый текст тела заметки -> ")
    input_id = ("\n     Введите ID заметки -> ")
    input_date = ("\n   Введите дату (в формате ДД-ММ-ГГГГ) для поиска заметок -> ")
    ...
    def choose(self):
        ...
        while flag:
            ...
            if choice == 1: # Добавление заметки
                ...
                self.main.get_by_date(input_date)
                continue
